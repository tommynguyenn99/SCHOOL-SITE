...
function fwd_school_theme_setup()
{
	...
	register_nav_menus(
		array(
			'header' => esc_html__('Header Menu Location', 'fwd-school-theme'),
			'footer-left' => esc_html__('Footer - Left Side', 'fwd-school-theme'),
			'footer-right' => esc_html__('Footer - Right Side', 'fwd-school-theme'),
			'footer-center' => esc_html__('Footer - Center', 'fwd-school-theme'),
		)
	);
